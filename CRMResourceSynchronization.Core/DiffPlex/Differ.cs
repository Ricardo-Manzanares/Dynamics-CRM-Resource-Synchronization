...
using CRMResourceSynchronization.Core.DiffPlex.Chunkers;
using CRMResourceSynchronization.Core.DiffPlex.Model;

namespace CRMResourceSynchronization.Core.DiffPlex
{
